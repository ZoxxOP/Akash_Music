# =======================================================
# ©️ 2025-26 All Rights Reserved by AnanyaBots (ZoxxOP) 🚀
...
ANANYAAPI = "http://46.250.243.52:1470"
...
async def download_song(link: str):
    ...
    def get_url():
        api_url = f"{ANANYAAPI}/song?query={vidid}"
        try:
...
async def download_video(link: str):
    ...
    def get_url():
        api_url = f"{ANANYAAPI}/video?query={vidid}"
        try:
            return requests.get(api_url).json().get("link")
        except:
            return None
