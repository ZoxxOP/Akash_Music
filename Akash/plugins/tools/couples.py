...
#BOT FILE NAME
from Akash import app as app
from Akash.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="|| ˹𖤍 𝐀𝐊𝐀𝐒𝐇 𖤍˼ ||",
            url=f"https://t.me/AnanyaBotSupport",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "Akash/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "AnanyaMusic/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("Akash/assets/cppic.png")
