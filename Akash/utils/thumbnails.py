# =======================================================
# ©️ 2025-26 All Rights Reserved by Ananya Bots (ZoxxOP) 🚀

# This source code is under MIT License 📜 Unauthorized forking, importing, or using this code without giving proper credit will result in legal action ⚠️
 
# 📩 DM for permission : @WTF_NoHope
# =======================================================
...
async def get_thumb(videoid):
    ...
    try:
        ...
        arial = ImageFont.truetype("Akash/assets/font2.ttf", 30)
        font = ImageFont.truetype("Akash/assets/font.ttf", 30)
        bold_font = ImageFont.truetype("Akash/assets/font.ttf", 33)

    
        text_size = draw.textsize("@AnanyaBots   ", font=font)
        draw.text((1280 - text_size[0] - 10, 10), "@AnanyaBots   ", fill="yellow", font=font)
